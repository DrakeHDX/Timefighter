...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //connect the views to variables

        Log.d(TAG, "onCreate called. Score is: $score")

        //1
        //findViewById to search for the View with the appropriate ID to store as a variable
        ...
        //2
        //setOnClickListener listens for button press and calls function to increment score
    ...
    private fun incrementScore() {
        //function containing logic to increment score
        score++
        ...
        //2
            countDownTimer = object :CountDownTimer(initialCountDown, countDownInterval) {
                ...
                override fun onFinish() {
                    //Call endGame() when timer finishes
                    endGame()
                }
            }
